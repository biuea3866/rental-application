...
export default function DisputeListPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () => getMyDisputesApi({ status: statusFilter, page: 0, size: 20 }),
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        ...
        {isError && (
          <div data-testid="error-state" className="text-center py-12 text-sm text-gray-500">
            분쟁 목록을 불러올 수 없습니다.
          </div>
        )}
          ...
          >
            <div className="flex items-start justify-between gap-2 mb-2">
              <span className="text-sm font-medium text-gray-900">
                대여 #{dispute.rentalId} — {REASON_LABELS[dispute.reason] ?? dispute.reason}
              </span>
